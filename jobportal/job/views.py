...
def User_signup(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            StudentUser.objects.create(user=user, mobile=C, image=f'{filename}.jpg', gender=G, Type= "student")
...
def User_signup(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            StudentUser.objects.create(user=user, mobile=C, image=img, gender=G, Type= "student")
